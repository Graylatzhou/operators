...
__C __export infiniopStatus_t infiniopReducemin(infiniopReduceminDescriptor_t desc, void *y, const void *x, void *dynamic_axes, uint64_t dynamic_axes_size, void *stream) {
